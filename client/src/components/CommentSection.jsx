...
const CommentSection = ({ id }) => {
  ...
  useEffect(() => {
    ...
    const fetchComments = async () => {
      try {
        const res = await axios.get(`https://thegreatquestionlibrary-1.onrender.com/api/comments/${id}`);
  ...
  const handleCommentSubmit = async () => {
    if (newComment.trim()) {
      try {
        ...
        await axios.post(`https://thegreatquestionlibrary-1.onrender.com/api/comments/${id}`, { comments: updatedComments });
