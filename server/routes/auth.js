...
import { normalizeNotes } from 'razorpay/dist/utils/razorpay-utils.js';
...
const sendVerifyMail = async (name, email, userid) => {
  try {
    const msg = {
      ...
      html: `<p>Hi ${name}, click <a href='https://thegreatquestionlibrary-1.onrender.com/api/auth/verify?id=${userid}'>here</a> to verify your account.</p>`,
    };
